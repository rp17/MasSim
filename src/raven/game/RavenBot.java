...
public class RavenBot extends MovingEntity implements IRavenBot {
	 ...
	 * memory.
	 */
	protected RavenSensoryMemory sensoryMem;

	/** the bot uses this object to steer */
	protected RavenSteering steering;

	/** the bot uses this object to plan paths */
	protected RavenPathPlanner pathPlanner;

	/** this is responsible for choosing the bot's current target */
	protected RavenTargetingSystem targSys;

	/**
	 * this handles all the weapons. and has methods for aiming, selecting and
	 * shooting them
	 */
	protected RavenWeaponSystem weaponSys;

	/**
	 * A regulator object limits the update frequency of a specific AI component
	 */
	protected Regulator weaponSelectionRegulator;
	protected Regulator goalArbitrationRegulator;
	protected Regulator targetSelectionRegulator;
	protected Regulator triggerTestRegulator;
	 ...
	 */
	protected double numSecondsHitPersistant;
	...
	transient protected ArrayList<Vector2D> vecBotVB;

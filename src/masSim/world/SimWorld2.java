			  ...
			  public void run() {
				  try {
						...
						for(int i=0;i<3;i++)
						{
							int interval = 5000;
							int sinterval = 2000;
							mainAgent.AddPendingTask(new Task("Station A1",new SumAllQAF(), mainAgent, new Method("Visit Station A1",10,100,110)));
							...
							mainAgent.AddPendingTask(new Task("Station B1",new SumAllQAF(), agents.get(1), new Method("Visit Station B1",1,100,210)));
							...
							mainAgent.AddPendingTask(new Task("EMG2",new SumAllQAF(), null, new Method("EMG2",1,240,220)));

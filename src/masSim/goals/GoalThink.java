...
*/
	/*
	public GoalThink(SimBot simBot) {
		super(simBot, Goal.GoalType.goal_think);
...
*/
	...
	public GoalThink(SimBot simBot, Goal.GoalType mode) {
		super(simBot, mode);
		/*
	...
	public CurrentStatus process(double delta) {
		...
		masSim.goals.Goal.CurrentStatus SubgoalStatus = ProcessSubgoals(delta);
	...
	public void Arbitrate() {
		...
		if(MostDesirable != null) {
			Log.debug("GoalThink", "Evaluator " + MostDesirable.getGoalType() + " was found for bot " + m_pOwner.getName());
